...
public class Game {
    ...
    public Game(Graphics2D g, KListener kl){
        ...
        //ball = new Ball(ballSize,(int)((GameData.windowWidth - ballSize)/2), (int)((GameData.windowHeight - ballSize) / 2), 1, 1, Color.WHITE);
        ball = new Ball(100, 200, 200, 1, 1, Color.WHITE);
        ball.drawBall(g);
